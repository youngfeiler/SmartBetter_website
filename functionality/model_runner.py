        ...
        for strategy_name, strategy_dict in self.model_storage.items():
            ...
            if this_model_raw_data_point is not False:
              ...
              if len(ind_list) > 0:
                ...
                self.handle_bets(bet_list, stacked_df, strategy_name, strategy_dict['params']['bettable_books'])
