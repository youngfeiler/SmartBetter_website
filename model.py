...
class oddsNet():
   ...
   def backtest(self):
      ...
      try:
         ...
         new_df.to_csv(f'/Users/stefanfeiler/Desktop/SmartBetter/SmartBetter/data/{self.name}_results.csv', index=False)
   ...
   def save_model(self, min_minutes_since_commence, max_minutes_since_commence, min_avg_odds, max_avg_odds, min_ev):
